...
class App(customtkinter.CTk):
    ...
    def first_figure(self):
        ...
        )  # Group the data by year and month, and sum the Value column for $ and Tonnes measures separately
    ...
    def second_figure(self):
        ...
        )  # Group the data by country, measure, year, and month, and sum the Value column for $ and Tonnes measures separately
        data = data.replace(
            [
    ...
    def fourth_figure(self):
        ...
        # Create pivot tables Day as rows, and the sum of values as values for $ and Tonnes measures separately
    ...
    def sixth_figure(self):
        ...
        plt.figure(figsize=(9.39, 6.48))  # Create the bar charts as subplots
        ...
        plt.title(
            "Top 5 Months with Highest Export Value($)",
            fontweight="bold",
            fontsize=16,
            y=1.05,
        )
    ...
    def seventh_figure(self):
        ...
        # Plot the top 6 commodities for each country as subplots in one figure
        countries = grouped.index.levels[0]
        num_plots = len(countries)
        num_rows = 3
        num_cols = round(num_plots // num_rows)
        axs = plt.subplots(num_rows, num_cols, figsize=(9.39, 6.48))
